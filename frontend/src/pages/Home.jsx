    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gray-50 pt-16 pb-12 md:pt-28 md:pb-20 text-center px-6">
        <div className="flex flex-col items-center mb-3">
          <img src="/archway_logo.png" alt="ARCHWAY 松上防水" className="h-9 md:h-14 w-auto opacity-60 mb-2" />
          <span className="text-xl md:text-[2.5rem] font-bold text-dark tracking-[0.12em]" style={{display:'inline-block', transform:'scaleX(0.95)'}}>松上ARCHWAY</span>
        </div>
